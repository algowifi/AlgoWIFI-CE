const token  = "49f27db9b910c6e3548de27e73af38697394906ff2c2f0aeace2fe2b15589bce";
...
//     alert(await algodClient.status().do());
// })().catch((e) => {
//     console.log(e);
//     alert(e);
// });
...
// //Check your balance
// let accountInfo = await algodClient.accountInformation('IV6VU6HCRU656FWFMECWFUHQWKWGLLE52Z6RYDJVTD44BQUTQ75ZJGA3IA').do();
// console.log("Account balance: %d microAlgos", accountInfo.amount);
